...
const Pricing = () => {
  return (
    <>
      <main
        className={`max-w-5xl h-full py-5 md:h-screen mx-auto mt-32 relative text-black ${montserrat.className}`}
      >
        ...
        <motion.div
          ...
          className="grid md:grid-cols-3 mt-10  gap-5 px-10 md:px-0 "
        >
